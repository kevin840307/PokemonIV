 ...
 */
public class MobAppraiseSearch extends Activity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv_main.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Data.LEADER_ASK = adapter.getItem(position).toString();
                FloatWindowManager.createPoint(FloatWindowView.getFloatContext());
                MobAppraiseSearch.this.finish();
